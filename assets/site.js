// RS-Expert site.js — полный рабочий файл (2025-12-23)
...
// SEO и schema (определены перед использованием)
...
// Boot-логика (после всех определений)
(async () => {
  let data = null;
  try {
  ...
  // Вызов render-функций (они должны быть определены выше)
