(async function () {
  ...
  const UI = {
      ...
      services: "Palvelut",
      works: "Työnäytteet", // (теперь не используется, но можно оставить)
      gallery: "Galleria",
      references: "Referenssit",
      showAll: "Näytä kaikki →",
      seeGallery: "Katso galleria →", // (теперь не используется на главной)
    ...
    ru: {
      ...
      requestQuote: "Заявка",
      services: "Услуги",
      works: "Примеры работ", // (не используется)
      gallery: "Галерея",
      references: "Референсы",
      showAll: "Показать все →",
      seeGallery: "Смотреть галерею →", // (не используется на главной)
      reviews: "Отзывы",
  ...
  // ✅ HOME: удалили только блок Työnäytteet (и всё, что нужно было только для него)
  function renderHome(data, lang, igFeed) {
    ...
    // На главной Instagram-превью НЕ показываем (оно в Galleria)
  ...
  // ✅ Gallery page: only Instagram preview block
